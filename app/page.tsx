          ...
          <div className="mt-4 text-xl pr-4 w-fit h-fit">
            <ul>
              {sideBarMenuItems.map((item) => (
                <li className="flex justify-start mt-2 items-center gap-4 hover:bg-gray-800 cursor-pointer rounded-2xl px-2 py-3">
            ...
            <button className="bg-[#1D9BF0] px-8 font-semibold py-2 text-xl w-full rounded-full">Post</button>
            </div>
          </div>
